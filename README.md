...
```bash
PYTHONPATH=. python scripts/01_download_eurostat_sbs.py
PYTHONPATH=. python scripts/02_download_business_demography.py
PYTHONPATH=. python scripts/03_download_oecd_sdbs.py
PYTHONPATH=. python scripts/04_download_istat_sources.py
PYTHONPATH=. python scripts/05_build_clean_datasets.py
